...
private Properties prop;
   ...
   public ArrayList<Mypage> myPostReply(Connection result, String user_nickname) {
      ...
      try {
         ...
         while ( rset.next() ) {
            ...
            mp.setReply_content(rset.getString("COL_REPLY_CONTENT"));
            mp.setReply_inserted_date(rset.getDate("COL_REPLY_INSERTED_DATE"));
            mp.setLog_check(rset.getInt("COL_LOG_CHECK"));
            mp.setBoard_elapsed_date(rset.getInt(9));
   ...
   public int logCount(Connection result, String user_nickname) {
      PreparedStatement pstmt = null;
      ResultSet rset = null;
      int num = 0;
      
      String sql =prop.getProperty("myPostReplyCount");
   ...
   public int logUpdate(Connection result, int rindex) {
      PreparedStatement pstmt = null;
      int num =0;
